...
When you open your account and see your balance, the mobile app doesn't directly access the bank's database.
...
The backend could be something such as:
...
The client doesn't need to know how the backend works.
...
So you can control who is allowed to access your API.
...
API Gateway publishes metrics that allow you to understand API behavior.
...
Responsible for things around the API:
...
The basic flow we should remember is:
...
Defines what API Gateway sends the request to.
...
A stage represents a deployment environment/version of an API.
