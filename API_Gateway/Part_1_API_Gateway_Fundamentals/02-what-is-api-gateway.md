...
- [x] What is an API?
- [x] What is Amazon API Gateway?
- [x] Why do we need API Gateway?
- [x] API Gateway responsibilities
- [x] API Gateway vs Backend
- [x] Request/Response flow
- [x] REST API vs HTTP API — basic understanding
- [x] Regional Endpoint
- [x] Basic terminology
...
**Next:** Part 1 → Concept 2 — **API, Resource, Method and Route**
